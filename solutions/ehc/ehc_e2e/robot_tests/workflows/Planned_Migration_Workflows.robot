...
E2E-9-C4: Perform planned migration in DR2S
    ...
    [Setup]    Apply Settings From Files    ${CONF DIR}generic.yaml    ${CONF DIR}E2EWF-9-C4-DR2S.config.yaml    ${CONF DIR}generic.yaml
...
E2E-9-C5: Perform planned migration in MP2S
    ...
    [Setup]    Apply Settings From Files    ${CONF DIR}generic.yaml    ${CONF DIR}E2EWF-9-C5-MP2S.config.yaml    ${CONF DIR}generic.yaml
    Cloud Administrator Opens Browser
    Cloud Administrator Login
    Cloud Administrator Adds Site
    Cloud Administrator Adds Vcenter
...
E2E-9-C6: Perform planned migration in MP3S
    ...
    [Setup]    Apply Settings From Files    ${CONF DIR}generic.yaml    ${CONF DIR}E2EWF-9-C6-MP3S.config.yaml    ${CONF DIR}generic.yaml
    Cloud Administrator Opens Browser
    Cloud Administrator Login
    Cloud Administrator Adds Site
    Cloud Administrator Adds Vcenter
