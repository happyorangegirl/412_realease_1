...
*** Test Cases ***
E2E-1-C1-test: Deploy LC1S cluster with Data Protection
    [Documentation]    E2E-1 LC1S As a cloud administrator, I would like to deploy LC1S cluster with Data Protection
