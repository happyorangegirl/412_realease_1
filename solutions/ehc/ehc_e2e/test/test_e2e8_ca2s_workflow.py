...
if __name__ == '__main__':
    ...
    # # srm.cloud_administrator_adds_vcenter_relationship()
    ...
    srm.cloud_administrator_failovers_avamar_policies_for_offline_avamar_grid()
    ...
    srm.cloud_administrator_on_demand_backup_vm()
    srm.cloud_administrator_on_demand_restore_vm()
    srm.cloud_administrator_failbacks_avamar_policies_after_restoring_avamar_grid()
    ...
    # srm.cloud_administrator_deletes_vcenter_relationship()
