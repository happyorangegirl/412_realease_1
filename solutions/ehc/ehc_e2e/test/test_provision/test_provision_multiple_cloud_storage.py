...
def __main__():
    ...
    _parent_dir = 'C:/ehc411_release_scenario/solutions/ehc/ehc_e2e'
    _global = os.path.join(_parent_dir, 'conf/generic.yaml')
    _wf = [
        os.path.join(_parent_dir, 'conf/E2EWF-2-LC1S_provision_multiple.config.yaml'),
    ]
    ...
    # wf.cloud_administrator_edits_cluster_site()
