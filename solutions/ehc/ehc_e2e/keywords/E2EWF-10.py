...
def __main__():
    ...
    _wf = [
        os.path.join(_parent_dir, 'conf/E2EWF-10.config.yaml'),
    ]
    ...
    wf.cloud_administrator_assigns_rp_to_all_vsphere_blueprint()

    wf.cloud_administrator_deploys_multiple_vms()

    wf.cloud_administrator_operates_vm_b()
    wf.cloud_administrator_on_demand_backup_vm_b()
    wf.cloud_administrator_on_demand_restore_vm_b()
    ...
    wf.cloud_administrator_removes_rp_from_all_vsphere_blueprint()
