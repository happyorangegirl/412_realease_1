...
def __main__():
    ...
    _wf = [
        os.path.join(_parent_dir, 'conf/scenario_conf/E2ESN-4-ADDITIONAL-DR2S.config.yaml'),
    ]
    ...
    wf.reverse_added_hwi_in_current_workflow()
    wf.generate_parameters_for_provision_cloud_storage()
